...
export default function Profile({ lecturer }: { lecturer: Lecturer_Full }) {
  return (
    <section className="flex items-center justify-center bg-jet">
      <div className="grid grid-cols-1 md:grid-cols-4 bg-white dark:bg-jet text-black dark:text-white p-6 sm:px-12 lg:px-24 shadow-xl">
